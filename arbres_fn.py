...
class Feuille:
    ...
    def __init__(self, etiquette_maj, nb_total, nb_etiquette, groupe):
        ...
        self.groupe = groupe
        self.ORHTAe = nb_etiquette['hta_essentielle']/(nb_total-nb_etiquette['hta_essentielle'])/(15609/4033)
        self.ORRenovasc = nb_etiquette['renovasculaire']/(nb_total-nb_etiquette['renovasculaire'])/(1377/18265)
        self.effectif_observe_HTAe = nb_etiquette['hta_essentielle']
        self.effectif_attendu_HTAe = round(15609/19642*nb_total)
        self.effectif_observe_renovasc = nb_etiquette['renovasculaire']
        self.effectif_attendu_renovasc = round(1377/19642*nb_total)
